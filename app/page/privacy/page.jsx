      ...
      <div className={styles.termsContainerInner}>
        ...
        <div className={styles.section}>
          <p>
            ...
            offers. The sole purpose of collecting this information is to
            provide you with enhanced service and improve our products and
            services.
          </p>
        </div>
        ...
        <div className={styles.section}>
          <p>
            ...
            containing information about new products, exclusive offers, or
            other relevant updates. If you no longer wish to receive such
        ...
        <div className={styles.section}>
          <p>
            ...
            rectify any inaccuracies. According to Data Protection Laws, you
            have the right to request information about the personal data we
            hold about you.
          </p>
        </div>
        <div className={styles.section}>
          <p>
            ...
            that all associated data and content, including active
            subscriptions, will be permanently lost. However, you can still
            access sportypredict services by registering with a new email
