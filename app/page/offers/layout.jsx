export const metadata = {
  ...
  description: "Discover the best betting sign up offers and welcome bonuses from top bookmakers. Get free bets, deposit match bonuses, and enhanced odds for new customers.",
  keywords: [
    "betting sign up offers", "welcome bonuses", "free bets", "deposit match bonus",
    "no deposit bonus", "cashback bonus", "enhanced odds", "betting promotions",
    "bookmaker offers", "new customer bonuses", "sports betting bonuses",
    "best betting deals", "betting site offers", "welcome offers"
  ],
  
  openGraph: {
    title: "Best Betting Sign Up Offers & Welcome Bonuses - SportyPredict",
    description: "Discover the best betting sign up offers and welcome bonuses from top bookmakers. Get free bets, deposit match bonuses, and enhanced odds.",
  ...
  twitter: {
    ...
    description: "Discover the best betting sign up offers and welcome bonuses from top bookmakers with SportyPredict.",
  },
...
const webPageSchema = {
  ...
  description: "Comprehensive guide to the best betting sign up offers, welcome bonuses, free bets, and promotional deals from top bookmakers",
  url: "https://sportypredict.com/offers",
  mainEntity: {
    "@type": "ItemList",
    ...
    itemListElement: [
      ...
      },
      {
        "@type": "Offer", 
        name: "Free Bet Bonus",
        description: "Free bet tokens to place wagers without risking your own money"
      },
      {
        "@type": "Offer",
...
const howToSchema = {
  ...
  description: "Step-by-step guide to selecting the best welcome bonus for betting sites",
  totalTime: "PT5M",
  step: [
    {
      "@type": "HowToStep",
...
const organizationSchema = {
  ...
  description: "Leading sports betting predictions and betting offers comparison platform",
  service: [
    {
      "@type": "Service",
      name: "Betting Offers Comparison",
      description: "Compare the best betting sign up offers and welcome bonuses"
    },
    {
      "@type": "Service",
...
const articleSchema = {
  ...
  description: "Comprehensive guide to understanding and choosing the best betting welcome bonuses including deposit match, free bets, and no deposit offers",
  author: {
    "@type": "Organization",
    name: "SportyPredict"
  },
...
import ClientLayout from "@/app/offers/clientLayout";
