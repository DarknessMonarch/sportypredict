      ...
      <div className={styles.bonusMain}>
        <div className={styles.bonusContent}>
          <div className={styles.bonusHeader}>
            ...
            <p>
              New customers only | commercial content 18 + age limit | T&Cs
              apply
            </p>
          </div>
          <OfferCard />
        ...
        <div className={styles.bonusInfo}>
          ...
          <p>
            ...
            to new users when they create an account and make their first
            deposit. The specifics of a welcome bonus can vary from one betting
            site to another, but common types of welcome bonuses in betting
            sites include:
          </p>
          <p>
            ...
            deposit made by the new user. For example, a 100% deposit match
            bonus on a $100 deposit would give the user an additional $100 in
            bonus funds to bet with.
          </p>
          <p>
          ...
          <p>
            <span>3. No Deposit Bonus:</span> In some cases, betting sites offer
            a no deposit bonus, which means that new users receive a small
            amount of bonus funds simply for signing up, without the need to
            make an initial deposit.
          </p>
          <p>
            <span>4. Cashback Bonus:</span> A cashback welcome bonus refunds a
            portion of the user&apos;s losses over a specific period, providing
            a form of insurance against initial losses.
          </p>
          <p>
